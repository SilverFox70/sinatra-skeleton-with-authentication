people = [{first_name: "Bill", last_name: "Brinkert", email: "wfbrinkert@gmail.com", age: 45, gender: "male", role: 1, password: "admin"},
 ...
 {first_name: "Jane", last_name: "Torvald", email: "TorJane@gmail.com", age: 37, gender: "female", role: 0, password: "zxcv"}]
 ...
 friends = [{user_id: 1, target_user_id: 2, relationship_code: 0},
            ...
            {user_id: 3, target_user_id: 4, relationship_code: 1},
            {user_id: 5, target_user_id: 4, relationship_code: 1}]

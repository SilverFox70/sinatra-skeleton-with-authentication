people = [{first_name: "Bill", last_name: "Brinkert", email: "wfbrinkert@gmail.com", age: 45, gender: "male", role: 1, password: "admin"},
 ...
 friends = [{user_id: 1, user_id: 2, relationship_code: 0},
            {user_id: 1, user_id: 3, relationship_code: 1},
            {user_id: 1, user_id: 4, relationship_code: 2},
            {user_id: 2, user_id: 3, relationship_code: 2},
            {user_id: 2, user_id: 4, relationship_code: 1}]
